...
struct ModelInfo: Identifiable, Hashable {
    ...
    static let choices: [ModelInfo] = [
        ...
        .init(id: "advanced", mode: .advanced, deblurMode: nil, title: "Advanced", modelName: "SeedVR2 3B 8-bit, 80% internal scale", backend: "Native MLX", minimumRAMGB: 16, recommendedRAMGB: 24, largeImageRAMGB: 32, defaultTiling: "auto", intendedUse: "High-quality SeedVR2 restoration using 8-bit precision and a reduced internal resolution for a meaningful speed improvement over Maximum."),
